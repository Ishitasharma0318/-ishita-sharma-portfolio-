...
import ss01 from '../assets/images/ss-01.png';
import lstmImage from '../assets/images/LSTM.jpeg';
import whatsappImage from '../assets/images/whatsapp2.png';
import tiktakImage from '../assets/images/Tiktak.jpeg';
import Contextmonitor from '../assets/images/Contextmonitor.jpeg';
    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={ss01} className="zoom" alt="One Click Resume to Portfolio Generator" width="100%"/></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={lstmImage} className="zoom" alt="LSTM Auto-Scaling Visualization" width="100%"/></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={whatsappImage} className="zoom" alt="WhatsApp Group Chat Analysis" width="100%"/></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={tiktakImage} className="zoom" alt="Tic-Tac-Toe AI Game App" width="100%"/></a>
            ...
            <div className="project">
                <a href="#" target="_blank" rel="noreferrer"><img src={Contextmonitor} className="zoom" alt="Context Monitor App" width="100%"/></a>
